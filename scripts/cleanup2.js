...
const prisma = new PrismaClient({
  datasources: {
    db: {
      url: 'postgresql://neondb_owner:q9kC6KRygjXe@ep-tiny-night-a5qd39g2-pooler.us-east-2.aws.neon.tech/cfv-content-engine?sslmode=require'
    }
  }
});
...
async function main() {
  ...
  final.forEach(s => {
    console.log(`${s.sessionId} - ${s.workingTitle.substring(0, 60)} (${s._count.assets} assets)`);
  });
}
