            ...
            <div key={image.id} className="bg-white border border-gray-200 rounded-lg p-3">
              ...
              <div className="flex gap-2">
                <a 
                  ...
                  className="px-2 py-1 bg-white border-2 border-green-600 text-green-600 hover:bg-green-50 rounded text-xs transition font-semibold"
                >
                  👁️ View
                </a>
                <a 
                  ...
                  download
                  className="px-2 py-1 bg-green-600 text-white hover:bg-green-700 rounded text-xs transition font-semibold"
                >
                  💾 Download
                </a>
              </div>
