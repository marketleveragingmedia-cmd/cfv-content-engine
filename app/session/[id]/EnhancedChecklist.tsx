  ...
  return (
    <div>
      <div className="mb-4 md:mb-6">
        <h2 className="text-xl md:text-2xl font-bold mb-4" style={{color: '#1E8E5A'}}>Publishing Checklist</h2>
          ...
          return (
            <div key={category} className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden">
              ...
              <button
                ...
                className="w-full p-3 md:p-4 hover:bg-gray-50 transition"
              >
                <div className="flex items-start md:items-center gap-3 md:gap-4">
                  <span className="text-xl md:text-2xl flex-shrink-0 pt-1 md:pt-0">
                    {isExpanded ? '▼' : '▶'}
                  </span>
                  <div className="text-left flex-1 min-w-0">
                    <h3 className="text-base md:text-lg font-bold text-gray-900">{category}</h3>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mt-1 text-xs md:text-sm">
                      <span className="text-gray-600">
                        {completed} / {total} tasks complete
                      </span>
                      <span className="hidden sm:inline text-gray-600">•</span>
                      <span className="font-semibold" style={{color: '#1E8E5A'}}>
                  ...
                  {/* Status Badge */}
                  <span className={`px-2 md:px-3 py-1 ${statusBg} ${statusColor} text-xs font-bold rounded-full uppercase whitespace-nowrap flex-shrink-0`}>
                    {groupStatus}
                  </span>
                </div>
              </button>
              ...
              {/* Group Content */}
              {isExpanded && (
                <div className="border-t-2 border-gray-200 bg-gray-50 p-2 md:p-4">
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-3 md:p-4">
      <div className="flex items-start gap-2 md:gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="mb-2">
            <h4 className="font-semibold text-sm md:text-base text-gray-900 mb-2">{item.title}</h4>
